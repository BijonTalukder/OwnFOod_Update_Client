...
const ProductsDetails = () => {
  ...
  useEffect(() => {
    axios.get(BaseURL + "/get-single-food/" + params.id).then((res) => {
      setFoodData(res.data.data[0]["Rows"][0]);
    });
  }, []);
          ...
          <div class='row'>
            <div class='col-lg-6 leftSide'>
              <div class='image_slider'>
                <ImageGallery
                  ...
                  items={[
                    {
                      original: foodData?.foodImage,
                      thumbnail: foodData?.foodImage,
                    },
                  ]}
                  showNav={false}
            ...
            <div class='col-lg-6 rightSide'>
              <div class='details-content'>
                <h3 class='details-name'>{foodData?.foodName}</h3>
                ...
                <div className='details-price'>
                  <h2>
                    <del>${foodData?.foodDiscountPrice}</del>
                  </h2>
                  <span>${foodData?.foodPrice}</span>
                </div>

                <p class='details-desc'>{foodData?.foodAdditionalInfo}</p>
                <div class='details-list-group'>
                  <label class='details-list-title'>tags:</label>
                  <ul class='details-tag-list'>
                    {foodData?.foodAdditionalTags?.map((item, index) => (
                      <li key={index}>
                        <a href='#'>{item}</a>
                      </li>
                    ))}
